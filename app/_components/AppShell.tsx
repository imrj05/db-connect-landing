...
const iconMap = {
    ...
    billing: RiPriceTag3Line,
    profile: RiUserLine,
    users: RiUserStarLine,
    licenses: RiStackLine,
    activations: RiDatabase2Line,
    plans: RiSettings3Line,
} satisfies Record<IconName, typeof RiDashboardLine>;
